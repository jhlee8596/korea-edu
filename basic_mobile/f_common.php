...
<footer>
    ...
    <div class="f_bottom">
      <ul class="f_nav02">
        ...
        <li>
          <a href="https://www.korea-edu.net/m/agree_more_comms1.html" title="이용약관">이용약관</a>
        </li>
        <li>
          <a href="https://www.korea-edu.net/m/agree_more_comms2.html" title="개인정보처리방침">개인정보처리방침</a>
        </li>
      </ul>
      ...
      <div class="f_inner">
        <div class="f_info01">
          <dl>
            <dt>
              <label for="more">
                (주)한국자격검정평가진흥원 <i class="fas fa-angle-down"></i>
              </label>
            </dt>
